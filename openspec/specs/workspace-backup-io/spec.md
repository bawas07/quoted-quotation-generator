# Workspace Backup I/O

## Purpose

Provides import and export of the entire workspace (catalog + history) as a JSON backup file for data portability and disaster recovery.
