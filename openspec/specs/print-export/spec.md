...
Provides browser-native print functionality for all quotation templates with proper A4 rendering, hidden UI chrome during print, and page-break handling for multi-page quotations.
