...
### Requirement: useTemplate composable
A `useTemplate` composable MUST export `isSwitching: Ref<boolean>` and `triggerSwitch()`.

#### Scenario: triggerSwitch sets isSwitching true then false
